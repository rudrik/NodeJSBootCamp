...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // GRANT ACCESS TO PROTECTED ROUTE AND ADDED THE CURRENT USER DATA TO THE REQ.USER THAT CAN BE USED BY OTHER MIDDLEWARE.
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  //2) Check if posted cirrent password is correct

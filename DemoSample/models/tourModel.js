...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function(val) {
          // This validator can only points to current doc on NEW document creation, it Wont work on the update
    ...
    // Embadded document need to be array in order to create it.
    locations: [
      {
        type: {
          type: String,
